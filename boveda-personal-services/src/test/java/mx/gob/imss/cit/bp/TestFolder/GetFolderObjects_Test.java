...
public class GetFolderObjects_Test {

	private CarpetaService iCarpetaService;
	private static final Logger LOG = LoggerFactory.getLogger(GetFolderObjects_Test.class);
	...
	@Test
	public void test_getObjectsFromFolder(){
		...
		try{		
			 iCarpetaService.getFolderObjects(tramiteTO, actorTO, baseTO);							
