 ...
 *       &lt;sequence>
 *         &lt;element name="Arbol" type="{http://ws.bp.cit.imss.gob.mx/bovedaPersonalCommonSchema}BaseObject" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends BaseResponse
{
    ...
    protected List<BaseObject> arbol;
     ...
     * 
     */
    public List<BaseObject> getArbol() {
        if (arbol == null) {
            arbol = new ArrayList<BaseObject>();
        }
        return this.arbol;
    }
