...
public final class ValidacionesConstants {
	 ...
	 */
	public static final String ER_ALFANUMERICO1A50 = "^[a-zA-Z0-9]{1,50}$";
	
	/**
	 * Constante para alfanumericos con guion
	 */
	public static final String ER_ALFANUMERICO1A50_CON_GUION = "^[a-zA-Z0-9\\-]{1,50}$";	
	/**
	 * Constante para alfanumericos con guion bajo y guin medio
	 */	
	public static final String ER_ALFANUMERICO1A50_CON_GUIONES = "^[a-zA-Z0-9\\-_]{1,50}$";
	/**
	 * Consntante que revisa que la cadena contenga numeros, letras y punto 
	 */
	public static final String ER_ALFANUMERICO_CON_PUNTO_1A50 = "^[a-zA-Z0-9/.]{1,50}$";	
	
	/**
	 * Constante que revisa que la cadena contenga numeros y guion y sea de 1 a 50 posiciones.
	 */
	public static final String ER_NUMERICO_CON_GUION_1A50 = "^[0-9\\-]{1,50}$";
	...
	/**
	 * Constante que revisa que la cadena contenga numeros, letras , y tenga(/:-) y sea de 60 posiciones.
	 */
	public static final String ER_ALFANUMERICO_CON_ESPECIALES_60 = "^[a-zA-Z0-9\\-\\:\\/]{60}$";
	
	/**
	 * Constante que revisa que la cadena contenga numeros, letras , caracteres especiales pero no contenga (\/:*?\"<>|)
	 *  y sea de 1 a 200 posiciones.
	 */
	public static final String ER_ALFANUMERICO_CON_ESPECIALES_1A200 = "^[^\\/:*?\"<>|]{1,200}$";
	/**
	 * Constante que revisa que la cadena contenga numeros, letras , caracteres especiales  (./-+)
	 * y sea de 1 a 100 posiciones.
	 */
	public static final String ER_ALFANUMERICO_CON_ESPECIALES_1A100 = "^[a-z0-9\\/.\\-\\+]{1,100}$";
	
	/**
	 * Constante que revisa que la cadena contenga numeros, letras , caracteres especiales pero no contenga (\/:*?\"<>|)
	 *  y sea de 1 a 50 posiciones.
	 */
	public static final String ER_ALFANUMERICO_CON_ESPECIALES_1A50 = "^[^\\/:*?\"<>|]{1,50}$";
	/**
	 * Constante que revisa que la cadena contenga numeros y guion y sea de 1 a 50 posiciones.
	 */
	public static final String ER_ALFANUMERICO_CON_GUION_1A50_ESPACIOS = "^[A-Za-z0-9\\-\\/\\_\\ ]{1,50}$";
	/**
	 * Constante que revisa que la cadena contenga numeros, guiones, puntos y sea de 1 a 150 posiciones.
	 */
	public static final String ER_ALFANUMERICO_CON_GUION_1A50_ESPACIOS_GUIONES = "^[A-Za-z0-9\\_\\-\\/\\ ]{1,150}$";
	
	/**
	 * Constante que revisa que la cadena contenga numeros, guiones, puntos y sea de 1 a 150 posiciones.
	 */
	public static final String ER_ALFANUMERICO_CON_GUION_1A150_PATH = "^[A-Za-z0-9\\_\\-\\/\\. ]{1,150}$";
	/**
	 * Constante para alfanumericos punto, con guion bajo y guin medio
	 */	
	public static final String ER_ALFANUMERICO1A50_CON_GUIONES_PUNTO = "^[a-zA-Z0-9\\-_\\. ]{1,50}$";
	/**
	 * Constante para alfabeticos, punto, y espacios
	 */	
	public static final String ER_ALFABETICO_1A50_CON_PUNTO_ESPACIO = "^[a-zA-Z\\. ]{1,50}$";
	...
	/**
     *Constante que define la expresion regular para decimales  de 2 enteros 2 decimales
     */
	public static final String ER_DECIMAL12E_2D = "^[0-9]{1,2}+(\\.{0,1}[0-9]{0,2})$";
	/**
	 ...
	 * Adjuntar el largo de la cadena as� ValidacionesConstant.ER_NUMERICO_LONGX + "{X}$"
	 */
	public static final String ER_NUMERICO_LONGVAR12 = "^[0-9]{1,12}$";
	/**
	...
	/**
	 * Constante que revisa que la cadena solo contenga numeros y sea de 1 a 5 posiciones.
	 */
	public static final String ER_NUMERICO5 = "^[0-9]{1,5}$";
	/**
	 * Constante que revisa que la cadena solo contenga numeros y sea de 1 a 4 posiciones.
	 */
	...
	/**
	 * Constante que define la expresion regular de un alfabetico de hasta 10p
	 */
	public static final String ER_ALFABETICO_10 = "^[a-zA-Z]{1,10}$";	
	/**
	 * Constante que define la expresi�n regular para Fecha de 8 d�gitos
	 */
	 ...
	 * Constante que revisa por cadenas numerica, de ceros.
	 */
	public static final String ER_EXTESIONES="^[a-zA-Z0-9]{1,4}$";
	/**
	 * Constante que revisa FORMATO CONTENT TYPE
	 */
	public static final String ER_CONTENTTYPE="^[a-zA|\\/]{1,20}$";
	
	/**
	 * Constante que revisa al uno o dos enteros con uno o dos decimales
	 */
	public static final String ER_NUM2_DEC2="[0-9]{1,2}+([,.][0-9]{1,2})";
}